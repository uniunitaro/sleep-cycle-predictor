    ...
    <Container maxW="4xl" px={{ base: 0, md: 4 }}>
      <CardMdOnly bg="contentBg" px={{ base: 4, md: 6 }} py="6">
        ...
        <CardBodyMdOnly>
          ...
          <SectionHeading>第2条（利用登録）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>
            第3条（ユーザーID（メールアドレス）およびパスワードの管理）
          </SectionHeading>
          <OrderedList>
            <ListItem>
              ユーザーは，自己の責任において，本サービスのユーザーID（メールアドレス）およびパスワードを適切に管理するものとします。
            </ListItem>
            <ListItem>
              ユーザーは，いかなる場合にも，ユーザーID（メールアドレス）およびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。運営者は，ユーザーID（メールアドレス）とパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーID（メールアドレス）を登録しているユーザー自身による利用とみなします。
            </ListItem>
            <ListItem>
              ユーザーID（メールアドレス）及びパスワードが第三者によって使用されたことによって生じた損害は，運営者に故意又は重大な過失がある場合を除き，運営者は一切の責任を負わないものとします。
            </ListItem>
          </OrderedList>
          <SectionHeading>第4条（禁止事項）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>第5条（本サービスの提供の停止等）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>第6条（利用制限および登録抹消）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>第7条（退会）</SectionHeading>
          <Text>
            ユーザーは，運営者の定める退会手続により，本サービスから退会できるものとします。
          </Text>
          <SectionHeading>第8条（保証の否認および免責事項）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>第9条（サービス内容の変更等）</SectionHeading>
          <Text>
            運営者は，本サービスの内容を変更，追加または廃止することがあり，ユーザーはこれを承諾するものとします。
          </Text>
          <SectionHeading>第10条（利用規約の変更）</SectionHeading>
          <OrderedList>
            <ListItem>
          ...
          <SectionHeading>第11条（個人情報の取扱い）</SectionHeading>
          <Text>
            運営者は，本サービスの利用によって取得する個人情報については，「プライバシーポリシー」に従い適切に取り扱うものとします。
          </Text>
          <SectionHeading>第12条（通知または連絡）</SectionHeading>
          <Text>
          ...
          <SectionHeading>第13条（権利義務の譲渡の禁止）</SectionHeading>
          <Text>
            ユーザーは，運営者の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
          </Text>
          <SectionHeading>第14条（準拠法・裁判管轄）</SectionHeading>
          <OrderedList>
            <ListItem>
